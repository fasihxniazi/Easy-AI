    ...
    <section className="relative min-h-[80vh] bg-transparent py-6 px-0 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-2 sm:px-6">
        ...
        <p className="text-slate-300 max-w-xl text-base animate-fadeIn delay-200 mb-6">
          Remove a specific object from your image using AI.
        </p>
          ...
          <div className="w-full md:w-1/2">
            <form onSubmit={onSubmitHandler} className="bg-[rgba(18,24,48,0.92)] border border-white/10 rounded-xl shadow-md px-5 py-4 w-full animate-fadeIn">
              ...
              <input
                ...
                required
              />
              <p className="mt-6 text-sm font-medium text-slate-200">Describe the object to remove</p>
              <input
                ...
                placeholder="Please enter only one object e.g. fence, person"
                required
              />
              <button
                disabled={loading}
                className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#417DF6] to-[#8E37EB] text-white px-4 py-2 mt-8 text-sm rounded-lg cursor-pointer font-semibold shadow-lg transition-transform duration-200 hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-indigo-500/20"
              >
                {loading ? (
              ...
              {!content ? (
                <div className="flex-1 flex justify-center items-center">
                  <div className="text-sm flex flex-col items-center gap-5 text-slate-400">
                    ...
                    <p>Describe the object and click "Remove Object" to get started</p>
                  </div>
                </div>
              ) : (
